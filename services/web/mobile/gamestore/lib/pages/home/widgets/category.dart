...
class CategorySection extends StatelessWidget {
  const CategorySection({Key? key, required}) : super(key: key);
  ...
  Widget _buildCategoryList(BuildContext context) {
    final categories = [
      ...
      const Category(
        ...
        color: Color(0xFF590059),
        title: 'Euro Symbol',
        description: 'Crypto Crossin Alert',
      ),
      const Category(
        svgString:
            '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 43 40" version="1.1" height="40px"><path d="m12.5 0l-12.5 8.1 8.7 7 12.5-7.8-8.7-7.3zm-12.5 21.9l12.5 8.2 8.7-7.3-12.5-7.7-8.7 6.8zm21.2 0.9l8.8 7.3 12.4-8.1-8.6-6.9-12.6 7.7zm21.2-14.7l-12.4-8.1-8.8 7.3 12.6 7.8 8.6-7zm-21.1 16.3l-8.8 7.3-3.7-2.5v2.8l12.5 7.5 12.5-7.5v-2.8l-3.8 2.5-8.7-7.3z"/></svg>',
      ...
      const Category(
        ...
        color: Color(0xFF99abb3),
        title: 'Date Range',
        description:
            'Alerte de date et heure \nAlerte chaque jour \nAlerte chaque mois \nAlerte chaque année',
      ),
      const Category(
        svgString:
      ...
      const Category(
          ...
          title: 'Spotify',
          description: 'Nouvelle Playlist Créer'),
    ];
